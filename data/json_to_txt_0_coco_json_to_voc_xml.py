...
savepath = "/home/zhangwei/NewDisk/zhangwei/DL/pytorch/yolov5/coco/val_"
datasets_list = ['val2017']  ##运行完之后再改为val2017再运行一次
...
dataDir = '/home/zhangwei/NewDisk/zhangwei/DL/pytorch/yolov5/coco/original'  ####### 连接到coco的数据集
headstr = """\
<annotation>
    <folder>VOC</folder>
    <filename>%s</filename>
