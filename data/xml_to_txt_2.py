...
def convert_annotation(image_id):
    ...
    in_file = open('/home/zhangwei/NewDisk/zhangwei/DL/pytorch/yolov5/coco/val_annotations/%s.xml' % (image_id))  ##########
    # print("3-convert to txt")
    out_file = open('/home/zhangwei/NewDisk/zhangwei/DL/pytorch/yolov5/coco/val_annotations_txt/%s.txt' % (image_id), 'w')  #######
...
for image_set in sets:
    ...
    image_ids = open('val_all.txt').read().strip().split()  ######
